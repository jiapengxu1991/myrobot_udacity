...
xterm -e "rosrun map_server map_server $(rospack find my_robot)/maps/myworldmap.yaml" &
sleep 5

# launch amcl node and setup initial pose
xterm -e "roslaunch turtlebot3_navigation amcl.launch initial_pose_x:=2.270 initial_pose_y:=0.018 initial_pose_a:=-3.136" &
sleep 5
